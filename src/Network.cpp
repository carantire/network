...
Network::Network(std::vector<int> dimensions, std::vector<Threshold_Id> threshold_funcs) : dimensions_(std::move(dimensions)),
threshold_funcs_(
...
Eigen::VectorXd Network::Back_Prop(const Eigen::VectorXd &start_vec, const Eigen::VectorXd &reference, const Score_Func &score_func, double coef) {
